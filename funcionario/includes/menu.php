...
<body>      
	...
	<div id="bg"></div>
		<nav class="menu" id="principal">
		    <ul>
				...
				<li class="nav-item" data-toggle="tooltip" data-placement="right" title="Entregas">
			        <a class="nav-link" onclick="disabled()" href="#">
			            <i class="fas fa-truck"></i>
			            <span class="nav-link-text" disabled>Entregas</span>
			        </a>
			    </li>
			    ...
			    <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Sair">
	...
	<script type="text/javascript">
		function disabled(){
			alert("Área exclusiva para a empresa!");
		}
	</script>